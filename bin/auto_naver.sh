...
(echo "${CRAWL_DATE}" | ("${CRAWLER_DIR}/NaverCrawler.py" "${CRAWLED_DATA_DIR}" -p 3 &> "${DETAIL_K_LOG_DIR}/crawling.log" && echo "[$(date +"%T")][INFO] Crawling has finished" >> ${GENERAL_LOG_PATH}); log_err "crawling") &
