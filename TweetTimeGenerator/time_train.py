...
if __name__ == '__main__':
    ...
    parser.add_argument('--hidden_state', type=int, help='size of hidden state', default=200)
    parser.add_argument('--epoch', type=int, help='number of epoch', default=5000)
...
#loss = loss + tf.reduce_sum(tf.cast(tf.less_equal(Y_pred, 0), tf.float32)*tf.abs(Y_pred))
    print(loss.shape)
    print(Y_pred.shape)
